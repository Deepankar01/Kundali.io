...
def generate_rasi_chart(dob: str, tob: str, latitude: float, longitude: float, timezone: str = "Asia/Kolkata"):
    """
...
# Example test run (will not be executed here)
# generate_rasi_chart("1990-05-15", "14:30", 28.6139, 77.2090)
